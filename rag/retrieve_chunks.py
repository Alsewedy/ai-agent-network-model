"""
retrieve_chunks.py – Baseline connectivity-aware RAG retriever for network hardening questions.
...
Key characteristics:
  ...
  3. DYNAMIC QUOTAS: For complex intents such as transition_plan, port_matrix
     and flow quotas can scale with the number of relevant flows.
...
def main():
    print("RAG Retriever (baseline connectivity-aware)")
